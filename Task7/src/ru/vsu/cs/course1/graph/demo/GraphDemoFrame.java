        ...
        buttonTree.addActionListener(e -> {
            try {
                ...
                showSystemOut(() -> {
                    ...
                    if (graph.vertexCount() - 1 == graph.edgeCount()) {
                        System.out.print("Это и есть дерево!"); // если количество вершин отличается от количества рёбер на один, то это дерево
                    }
                    GraphAlgorithms.deleteAdjTree(graph); //
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        textAreaGraphFile.setText("4 0 1 1 2 2 3 3 0");
        ...
        buttonTree = new JButton();
        buttonTree.setText("Как свести граф к дереву?");
        panel6.add(buttonTree, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
